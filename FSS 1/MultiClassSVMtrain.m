function [mdl]= MultiClassfitcsvm(featuretrain1,featuretrain2,featuretrain3,featuretrain4)
%% 1 versus 2 3 4
data1= featuretrain1;
...
mdl.svm1= fitcsvm(datatrain',labeltrain);
...
datatrain=[data1,data2];
labeltrain = [ones(1,size(data1,2)),2*ones(1,size(data2,2))];
mdl.svm2= fitcsvm(datatrain',labeltrain);
...
datatrain=[data1,data2];
labeltrain = [ones(1,size(data1,2)),2*ones(1,size(data2,2))];
mdl.svm3= fitcsvm(datatrain',labeltrain);
...
datatrain=[data1,data2];
labeltrain = [ones(1,size(data1,2)),2*ones(1,size(data2,2))];
mdl.svm4= fitcsvm(datatrain',labeltrain);
